...
public class ProdutoDto {
	...
	public ProdutoDto(Produto produto) {
		...
		this.margemContribuicao = produto.getMargemContribuicao();
		this.controlarEstoque = produto.getControlarEstoque();
		...
		this.origem = produto.getOrigem();
		this.referenciaEanGtin = produto.getReferenciaEanGtin();
		this.pesoUnitarioBrutoKg = produto.getPesoUnitarioBrutoKg();
		this.pesoUnitarioLiquidoKg = produto.getPesoUnitarioLiquidoKg();
		this.ncm = produto.getNcm();
		this.exIpi = produto.getExIpi();
		this.cBenef = produto.getcBenef();
		this.uCom = produto.getuCom();
		this.utrib = produto.getUtrib();
		this.qtdTributada = produto.getQtdTributada();
		this.anotacoesNfe = produto.getAnotacoesNfe();
	}
